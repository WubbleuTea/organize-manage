const allRoleNames = require('../server')
...
const addEmployee = [
    ...
    },
    {
        ...
        choices: ['Sally Joe', 'Billy Sue', 'John Doe', 'Jane Dane']
    }
];
...
const updateRole = [
    ...
    },
    {
        ...
        name: 'role',
        message: 'Please select the new role of this employee.',
        choices: ['Sales Lead', 'Sales Person', 'Junior Engineer', 'HR Specialist']
    },
];

module.exports = { openingQuestion, addDept, addRole, addEmployee, updateRole }

// I need to find a way to populate the choices from the table.